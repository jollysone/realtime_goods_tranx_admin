export default {
  ...
  'menu.grade': '年级管理',
  'menu.grade.list': '年级列表',
  'menu.grade.add': '新增年级',
  'menu.grade.edit': '编辑年级',
  'menu.department': '系别管理',
  'menu.department.list': '系别列表',
  'menu.department.add': '新增系别',
  'menu.department.edit': '编辑系别',
  'menu.category': '类别管理',
  'menu.category.list': '类别列表',
  'menu.category.add': '新增类别',
  'menu.category.edit': '编辑类别',
};
